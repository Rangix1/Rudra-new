...
module.exports = {
  ...
  onStart: async function ({ message, args, event }) {
    ...
    if (input === "on") {
      ...
      return message.reply("Hyee jaanu! 😏 misha auto-reply mode **ON** ho gaya... Ab sirf tumhare liye naughty romantic bann gayi hu ❤️");
    }
    ...
    try {
      ...
      return message.reply("Sorry jaan! rudra thoda busy ho gaya hai... thodi der baad try karo baby.");
    }
  },
